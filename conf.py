...
BLOG_AUTHOR = "Nitish Govindarajan"  # (translatable)
...
BLOG_EMAIL = "gnitish.1991@gmail.com"
BLOG_DESCRIPTION = "Nitish's site"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://aboutme.html', 'About me', 'icon-user'),
        ('https://twitter.com/nitish_91', 'My Twitter', 'icon-twitter'),
